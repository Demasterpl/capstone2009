...
namespace UI.Dialogs
{
    ...
    public partial class DrawingDialog : Form
    {
         ...
         */
        public DrawingDialog(ImageDraw drawOnImage)
        {
            InitializeComponent();

            ImageDraw = drawOnImage;

            SetTextBoxValues();

            lineStyleComboBox.Items.AddRange(drawOnImage.LineShapeTypes.ToArray());
