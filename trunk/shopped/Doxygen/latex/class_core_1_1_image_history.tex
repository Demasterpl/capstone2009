...
\index{Core::ImageHistory@{Core::ImageHistory}!ImageHistory@{ImageHistory}}
\index{ImageHistory@{ImageHistory}!Core::ImageHistory@{Core::ImageHistory}}
\subsubsection[{ImageHistory}]{\setlength{\rightskip}{0pt plus 5cm}Core::ImageHistory::ImageHistory ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\index{Core::ImageHistory@{Core::ImageHistory}!CurrentRevision@{CurrentRevision}}
\index{CurrentRevision@{CurrentRevision}!Core::ImageHistory@{Core::ImageHistory}}
\subsubsection[{CurrentRevision}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf Core::ImageHistory::CurrentRevision}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
...
\index{Core::ImageHistory@{Core::ImageHistory}!ImageRevisions@{ImageRevisions}}
\index{ImageRevisions@{ImageRevisions}!Core::ImageHistory@{Core::ImageHistory}}
